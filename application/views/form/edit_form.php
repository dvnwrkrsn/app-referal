...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>form/form/save_edit">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" rows="3" name="keterangan" placeholder="-- Keterangan --"><?php echo $pengaduan['keterangan']?></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="col-md-2">
                                <label for="ket" required>Hasil Pemeriksaan</label>
                            </div>
                            <div class="col-md-10">
                                <textarea class="form-control" rows="3" name="hasil_pemeriksaan" placeholder="-- Hasil Pemeriksaan --"><?php echo $pengaduan['hasil_pemeriksaan'] ?></textarea>
                            </div>
                        </div>
                        </div>                   
                    </div>
